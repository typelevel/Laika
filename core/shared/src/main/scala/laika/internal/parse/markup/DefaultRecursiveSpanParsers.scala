...
import laika.parse.markup.{ InlineParser, InlineParsers, RecursiveSpanParser, RecursiveSpanParsers }
...
/** Default implementation for parsing inline markup recursively.
  ...
  * @author Jens Halm
  */
private[internal] trait DefaultRecursiveSpanParsers extends RecursiveSpanParsers
