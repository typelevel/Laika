...
class LanguageSpec extends FunSuite {
  ...
  def result(lang: String, spans: CodeSpan*): Either[ParserError, RootElement] = Right(
    RootElement(
  ...
  test("XML") {
    ...
    val expected = result(
      ...
      keyword("PUBLIC"),
      punct("  "),
      qstring("-//W3C//GIF logo//EN"),
      spacePunct,
      qstring("http://www.w3.org/logo.gif"),
      spacePunct,
      keyword("NDATA"),
      spacePunct,
      id("gif"),
      ...
      comment("<!-- some comment -->"),
      nl(2),
      CodeSpan("<? some pi ?>", CodeCategory.XML.ProcessingInstruction),
      nl(2),
      CodeSpan("<![CDATA[some cdata content]]>", CodeCategory.XML.CData),
      nl(0),
      punct("</"),
      tagName("foo"),
      close
  ...
  test("JSON") {
    ...
    def attrName(value: String): CodeSpan =
      CodeSpan("\"" + value + "\"", CodeCategory.AttributeName)
  ...
  test("EBNF") {
    ...
    val expected                         = result(
      ...
      id("Type"),
      other("\n               |  "),
      id("HKTypeParamClause"),
      space,
      lit("=>"),
      space,
      id("Type"),
      other("\n"),
      declName("FunArgTypes"),
      other("  "),
      punct("::="),
      other("  "),
      id("InfixType"),
  ...
  test("Markdown") {
    ...
    val expected = result(
      ...
      header("### Header"),
      txt("\n\n"),
      CodeSpan(">", CodeCategory.Markup.Quote),
      txt(" Quote")
    )
  ...
  test("reStructuredText") {
    ...
    val expected = result(
      ...
      linkTarget("[#note]_"),
      txt(" and "),
      linkTarget("`one more ref`_"),
      txt(" and "),
      subst("`role text`"),
      txt("\nand "),
      id("_`internal target`"),
      txt(".\n\n"),
      header("Header1\n======="),
      txt("\n\n"),
      header("++++++++\nHeader 2\n++++++++"),
  ...
  test("HTML with Laika extensions") {
    ...
    val expected = result(
      ...
      attrName("scope"),
      colonSpace,
      CodeSpan("sections", CodeCategory.StringLiteral),
      other("\n    "),
      attrName("depth"),
      colonSpace,
      number("2"),
      ...
      close,
      nl(6),
      subst("${cursor.currentDocument.content}"),
      nl(4),
      punct("</"),
      tagName("div"),
      close,
