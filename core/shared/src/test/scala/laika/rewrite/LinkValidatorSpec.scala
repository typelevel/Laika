...
class LinkValidatorSpec extends FunSuite {
  ...
  test("invalid link target") {
    assertEquals(testCursor.validate(testTarget("../tree-1/doc-9.md")), InvalidTarget("unresolved internal reference: ../tree-1/doc-9.md"))
  }
  ...
  test("invalid span link") {
    ...
    assertEquals(testCursor.validate(link), Left("unresolved internal reference: ../tree-1/doc-9.md"))
  }
