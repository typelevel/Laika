...
```scala
libraryDependencies += "org.planet42" %% "laika-core" % "0.19.0-RC1" 
```
...
```scala
libraryDependencies += "org.planet42" %% "laika-io" % "0.19.0-RC1" 
```
...
```scala
libraryDependencies += "org.planet42" %% "laika-pdf" % "0.19.0-RC1" 
```
